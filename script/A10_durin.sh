...
# ==========================================================
# KONFIGURASI DURIN (CLIENT 50 HOST) - MODUL 5
# Subnet A10: 10.66.0.64/26
# ==========================================================

echo "Mulai konfigurasi Durin (Client 50 Host)..."
...
# eth0: ke Switch 3 (A10). Durin IP: 10.66.0.66
auto eth0
...
echo -e "\n=== UJI PING KE GATEWAY (Wilderland 10.66.0.65) ==="
ping -c 3 10.66.0.65
...
ip a | grep 'eth0'
echo "Pastikan eth0 mendapatkan IP 10.66.0.66 ke atas dan gateway 10.66.0.65."
