...
# ==========================================================
# KONFIGURASI CIRDAN (CLIENT 20 HOST) - MODUL 5
# Subnet A5: 10.66.0.128/25
# ==========================================================

echo "Mulai konfigurasi Cirdan (Client 20 Host)..."
...
# eth0: ke Switch 5 (A5). Cirdan IP: 10.66.0.130
auto eth0
...
echo -e "\n=== UJI PING LINTAS JARINGAN (Contoh ke Minastir 10.66.0.2) ==="
ping -c 3 10.66.0.2
